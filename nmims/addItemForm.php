...
<div id="heading"><strong>Add Item</strong></div>
<form method="post" action="addItem.php" name="myform" id="myform">
	<table id="addform" cellpadding="5" cellspacing="10" width="400" align="center">
       ...
       <tr class="tr1">
        	<td colspan="2"><input type="submit" name="SUBMIT" id="SUBMIT" value="Add Item"/></td>    
       </tr>
       </table>
